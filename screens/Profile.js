...
class Profile extends React.Component {
  ...
  handleYes = async () => {
    ...
    if(!result.cancelled){
      ...
      // console.log(blob)
      // await storageRef.child(this.props.user.id).put(blob, {contentType:'image/jpeg'})
      ...
      // console.log(file)
      // await storageRef.child(this.props.user.id).putString(result.base64, 'base64', {contentType:'image/jpeg'})
